...
async function exportToPNG(el:HTMLElement,title:string,floorName:string){const{default:html2canvas}=await import("html2canvas" as any);const canvas=await html2canvas(el,{backgroundColor:"#fafafa",scale:2,useCORS:true});const a=document.createElement("a");a.download=`${title}_${floorName}.png`;a.href=canvas.toDataURL("image/png");a.click();}
